...
public class ClassiffyIn {
List<String> cli = new ArrayList<String>();
    List<String> pli = new ArrayList<String>();
    public void test(String Name, int review, List<String> phrase, String subject) throws Exception {

        DataSource source = new DataSource("C:\\Users\\Nifras\\Documents\\EGDownloads\\gate-nlp\\Tutorial\\Tutorial\\Examples\\Example1\\beach 1.arff");
      ...
      NaiveBayes nb = new NaiveBayes();
       ...
       // LibSVM nb = new LibSVM();
        ...
        DataSource source1=new DataSource("C:\\Users\\Nifras\\Documents\\EGDownloads\\gate-nlp\\Tutorial\\Tutorial\\Examples\\Example1\\m2.arff");
       ...
       for(int i=0;i<filterTestDataset.numInstances();i++){
           ...
           String phrase1 = phrase.get(i);
            //System.out.println(actual);
            System.out.println("Name :" +"" + Name);
            System.out.println("Review: "+" "+review);
            System.out.println("phrase: "+" " +phrase1);
            //System.out.println("subject:" +" " + subject);
            System.out.println("Sentiment value:" +" "+predString );
           cli.add(predString);
           pli.add(phrase1);
        ...
        m.insertMongoDocuments(pli,cli);

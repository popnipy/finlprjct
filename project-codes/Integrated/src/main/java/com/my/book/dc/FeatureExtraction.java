       ...
       /* DatatoArff arff = new DatatoArff();
        ...
        LanguageAnalyser jape = (LanguageAnalyser)Factory.createResource(
                "gate.creole.Transducer", Utils.featureMap(
                        "grammarURL", new
                                File("E:\\finalProject\\japeFiles\\japeRules.jape").toURI().toURL(),
        ...
        URL u = new URL("file:E:\\finalProject\\Beaches\\reviewFile\\beach.txt");
...
// extract results
        ...
        while(iter.hasNext()) {
          ...
          /*  annotTypesRequired.add("Person");
            ...
            annotTypesRequired.add("FeatureExtraction");
...
//Factory.deleteResource(pipeline.getCorpus());
        Factory.deleteResource(tokeniser);
        Factory.deleteResource(splitter);
        Factory.deleteResource(pos);
        Factory.deleteResource(gazetter);
      //  Factory.deleteResource(pipeline);

       /* pipeline.removeControllerListener(corpus);
        pipeline.removeProgressListener(corpus);*/

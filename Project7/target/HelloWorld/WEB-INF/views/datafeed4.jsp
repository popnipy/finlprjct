...
<div>
    <table class="table table-inverse">
        ...
        <tr style="background-color: #0059b3">
            ...
            <th>Nature Places and Ratings</th>
        </tr>
        </thead>
        <tbody>

        <c:forEach items="${datafeedsForm4}" var="theme" varStatus="status">
...
<div style="background-color: rgba(177, 255, 236, 0.92)" align="center">
    ...
    <h2>${sugession4}</h2>
    <img src="resources/images/${sugession4}.jpg" class="img-circle" alt="Cinque Terre" width="304" height="236">
</div>

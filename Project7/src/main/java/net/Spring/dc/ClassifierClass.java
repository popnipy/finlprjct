...
public class ClassifierClass {
    ...
    public  void m(int r, List<String> ri, String str) throws Exception {

        DataSource source = new DataSource("E:\\finalProject\\Beaches\\arffFiles\\common7Copy.arff");
       ...
       // DataSource source1=new DataSource("E:\\finalProject\\Beaches\\arffFiles\\beachCopy.arff");
        DataSource source1=new DataSource("E:\\finalProject\\Beaches\\arffFiles\\common7Copy.arff");
        ...
        for(int i=1;i<r+1;i++) {
           ...
           // pli.add(phrase1);
            ...
            m.insertMongoDocuments(pli, cli,str);

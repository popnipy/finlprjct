...
public class DatatoArff {
    ...
    public void addAttribute(List<String> Scenic, int annotationCount, String str) throws Exception {
     ...
     // IOUtils.closeQuietly(data);
       addData(Scenic,annotationCount,str);


    }

    public void addData(List<String> Scenic, int annotationCount, String str) throws Exception {
 ...
 int b = Scenic.size()-1;
      ...
      File fl = new File("E:\\finalProject\\Beaches\\arffFiles\\common7Copy.arff");
       ...
       // copyFileUsingStream(f1l, fl);
        ...
        objCl.m(annotationCount,Scenic,str);

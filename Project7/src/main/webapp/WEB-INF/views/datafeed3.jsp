...
<div>
    <table class="table table-inverse">
        ...
        <c:forEach items="${datafeedsForm3}" var="theme" varStatus="status">
...
<div style="background-color: rgba(177, 255, 236, 0.92)" align="center">
    ...
    <h2>${sugession3}</h2>
    <img src="resources/images/${sugession3}.jpg" class="img-circle" alt="Cinque Terre" width="304" height="236">
</div>

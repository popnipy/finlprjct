...
<div>
    <table class="table table-inverse">
        ...
        <c:forEach items="${datafeedsForm2}" var="theme" varStatus="status">
...
<div style="background-color: rgba(177, 255, 236, 0.92)" align="center">
    ...
    <h2>${sugession2}</h2>
    <img src="resources/images/${sugession2}.jpg" class="img-circle" alt="Cinque Terre" width="304" height="236">
</div>
